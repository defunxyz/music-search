...
const HistoryButton = (props) => {
    ...
    return (
        <div className="floating-circle-btn" onClick={() => {props.showHistoryPopOver()}}>
            <div className="btn-content">
                <svg className="time-icon" height="32" viewBox="0 0 48 48" width="32" xmlns="http://www.w3.org/2000/svg">
